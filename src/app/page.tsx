        ...
        <div className="relative">
          ...
          <Reveal delay={260}>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/services"
                className="interactive-press focus-ring rounded-full bg-stone-950 px-6 py-3 text-center text-sm font-semibold text-white transition hover:bg-rose-700 dark:bg-rose-100 dark:text-stone-950 dark:hover:bg-rose-200"
              >
                {content.primaryCta}
              </Link>
          ...
          >
            {content.stats.map((stat) => (
              <div
                ...
                className="interactive-lift rounded-3xl border border-rose-200 bg-white/70 p-4 text-center shadow-sm backdrop-blur dark:border-stone-800 dark:bg-stone-900/70"
              >
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <Reveal stagger className="mt-10 grid gap-5 md:grid-cols-3">
            {content.services.map((service) => (
              <article
                key={service.title}
                className="interactive-lift rounded-4xl border border-rose-200 bg-rose-50 p-6 shadow-sm hover:border-rose-300 hover:shadow-xl hover:shadow-rose-200/60 dark:border-stone-800 dark:bg-stone-950 dark:hover:border-stone-700 dark:hover:shadow-black/30"
              >
          ...
          <Reveal delay={160}>
            <div className="mt-10">
              <Link
                href="/services"
                className="interactive-press focus-ring inline-flex rounded-full border border-rose-300 px-6 py-3 text-sm font-semibold text-stone-950 transition hover:border-rose-500 hover:bg-rose-50 hover:text-rose-700 dark:border-stone-700 dark:text-rose-50 dark:hover:border-rose-300 dark:hover:bg-stone-900 dark:hover:text-rose-200"
              >
                {content.primaryCta}
              </Link>
            </div>
